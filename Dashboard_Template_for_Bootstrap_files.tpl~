      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="/home/yikang/fengy2/index1.tpl">Overview <span class="sr-only">(current)</span></a></li>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  <td>1,001</td>
                  <td><h2><div id="redisKeys">test area</div></h2>
</td>
                  <td>ipsum</td>
                  <td>dolor</td>
                  <td>sit</td>

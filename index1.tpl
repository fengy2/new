...
<!-- start preloader -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 border_right border_bottom wow fadeIn" data-wow-delay="0.6s">
					<div class="media">
						<div class="pull-left media-object">
							<img src="/static/images/team_img_1.jpg" class="img-circle img-responsive" alt="team img">
						</div>
				...
				<div class="col-md-6 col-sm-6 border_bottom wow fadeIn" data-wow-delay="0.6s">
					<div class="media">
						<div class="pull-left media-object">
							<img src="/static/images/team_img_2.jpg" class="img-circle img-responsive" alt="team img">
						</div>
						<div class="media-body">
				...
				<div class="col-md-6 col-sm-6 border_right wow fadeIn" data-wow-delay="0.6s">
					<div class="media">
						<div class="pull-left media-object">
							<img src="/static/images/team_img_3.jpg" class="img-circle img-responsive" alt="team img">
						</div>
						<div class="media-body">
				...
				<div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.6s">
					<div class="media">
						<div class="pull-left media-object">
							<img src="/static/images/team_img_4.jpg" class="img-circle img-responsive" alt="team img">
						</div>
						<div class="media-body">
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p class="templatemo-copyright">Copyright © 2084 Your Company Name | More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
